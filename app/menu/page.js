  ...
  const pizzas = products.map((pizza) => (
    <Link href={`/product/${pizza.id}`}>
      <div className="flex flex-col justify-center items-center text-black hover:text-red-500 duration-500 mb-5 group">
        ...
        <h2 className="text-2xl font-extrabold mt-2">{pizza?.title}</h2>
  ...
  return (
    <MainLayout>
      <section
        ...
        <div className="py-20 max-w-[1500px] flex flex-col justify-center items-center relative mt-10 mb-10 ">
