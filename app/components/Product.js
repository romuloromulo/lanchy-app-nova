  ...
  return (
    <>
      <Link
        ...
        className="max-w-[200px] text-white md:h-64 w-40 md:w-40 p-2 mt-2 border-2 border-black flex flex-col items-center justify-center bg-red-500 rounded text-center mx-auto">
        {product?.url ? (
          <Image
